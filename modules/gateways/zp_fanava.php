<?php
     ...
     *::: myvahab@gmail.com
     */
function zp_fanava_config() {
    $configarray = array(
     "FriendlyName" => array("Type" => "System", "Value"=>"پرداخت آنلاین فن آوا"),
	 ...
	 "MirrorName" => array("FriendlyName" => "نود اتصال", "Type" => "dropdown", "Options" => "آلمان,ایران,تست,خودکار", "Description" => "چناانچه سرور شما در ایران باشد ایران دا انتخاب کنید و در غیر اینصورت آلمان و یا خودکار را انتخاب کنید", ),
...
function zp_fanava_link($params) {
	...
	$code = '
    <form method="post" action="./zp_fanava.php">
